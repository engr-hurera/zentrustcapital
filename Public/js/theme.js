...
function colorChangeToDark() {
  document.getElementById("btt").style.background =
    "linear-gradient(135deg, #c8a84b, #e6c96a)";
  ...
  root.style.setProperty(
    "--surface-plat-hl",
    "linear-gradient(145deg, var(--ink3), rgba(42, 74, 69, .25))",
  );
  ...
  root.style.setProperty(
    "--shadow-plat-btn",
    "0 6px 22px rgba(14, 96, 160, .22)",
  );
  root.style.setProperty(
    "--shadow-btn-main",
    "0 8px 32px rgba(27, 184, 154, .35)",
  );
  root.style.setProperty(
    "--shadow-btn-main-hover",
    "0 14px 40px rgba(27, 184, 154, .55)",
  );
  root.style.setProperty(
    "--shadow-btn-cta",
    "0 4px 18px rgba(14, 96, 160, .22)",
  );
  root.style.setProperty(
    "--shadow-btn-cta-hover",
    "0 8px 28px rgba(27, 184, 154, .45)",
  );
  root.style.setProperty(
    "--shadow-bk-btn",
    "0 6px 22px rgba(14, 96, 160, .25)",
  );
  root.style.setProperty(
    "--shadow-emblem",
    "0 4px 24px rgba(200, 168, 75, .2)",
  );
  ...
  document.getElementsByTagName("header")[0].style =
    "background: rgba(10, 14, 13, .7); transition: none;";
  ...
  root.style.setProperty(
    "--fb-ico-bg",
    "linear-gradient(145deg, rgba(42, 74, 69, .8), rgba(42, 74, 69, .3))",
  );
  ...
  root.style.setProperty(
    "--stats-bg",
    "linear-gradient(135deg, #2a4a45 0%, #182120 50%, #2a4a45 100%)",
  );
  ...
  root.style.setProperty(
    "--art-bg-1",
    "linear-gradient(145deg, #0c2822, #1a5e50, rgba(200, 168, 75, .12))",
  );
  root.style.setProperty(
    "--art-bg-2",
    "linear-gradient(145deg, #1a0c22, #4a1a5e, rgba(200, 168, 75, .08))",
  );
  root.style.setProperty(
    "--art-bg-3",
    "linear-gradient(145deg, #220c0c, #5e1a1a, rgba(200, 168, 75, .08))",
  );
  root.style.setProperty(
    "--art-bg-4",
    "linear-gradient(145deg, #0c1a22, #1a3a5e, rgba(27, 184, 154, .1))",
  );
  ...
  root.style.setProperty(
    "--ib-bg",
    "linear-gradient(145deg, var(--sage) 0%, var(--ink3) 55%, var(--ink2) 100%)",
  );
  ...
  root.style.setProperty(
    "--cta-bg",
    "linear-gradient(145deg, var(--sage) 0%, var(--ink3) 40%, var(--sage2) 100%)",
  );
  ...
  root.style.setProperty(
    "--cta-btn-main-bg",
    "linear-gradient(135deg, var(--blue-to-teal12), var(--darkBlue-to-sage2))",
  );
  root.style.setProperty(
    "--cta-btn-main-hover-bg",
    "linear-gradient(135deg, var(--blue-to-teal12), var(--darkBlue-to-sage2))",
  );
...
function colorChangeToLight() {
  ...
  root.style.setProperty(
    "--cta-bg",
    "linear-gradient(145deg, var(--sage) 0%, var(--sage2) 40%, var(--sage) 100%)",
  );
...
function ChangeNightMode(btn) {
  ...
  document
    .querySelectorAll(
      "body,nav,footer,div,a,button,.bk-card,.art-card,.why-card,.edu-card,.tool-card,.test-card",
    )
  ...
  if (
    isOn == 0 &&
    window.getComputedStyle(document.getElementsByTagName("header")[0])
      .backgroundColor == "rgba(240, 245, 249, 0.82)"
  ) {
    colorChangeToDark();
...
(function () {
  const saved =
    localStorage.getItem("ztc-theme") ||
    "ThemeOnlyByFetchingPreferedBrowserTheme";
  console.log(saved);
